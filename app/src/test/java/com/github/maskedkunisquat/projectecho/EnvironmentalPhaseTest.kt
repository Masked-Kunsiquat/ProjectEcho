...
class EnvironmentalPhaseTest {
    ...
    @Test fun `from 60 is Fertile - upper boundary`() = assertEquals(EnvironmentalPhase.Fertile, EnvironmentalPhase.from(60))
    @Test fun `from 61 is Saturated - lower boundary`() = assertEquals(EnvironmentalPhase.Saturated, EnvironmentalPhase.from(61))
